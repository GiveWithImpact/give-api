...
exports.user_type_ids = [1, 2, 3];

// Create a password hash
module.exports.createPasswordHash = function ( username, password ) {
...
module.exports.findAll = function ( query, limit, offset ) {
	return new Promise(function ( resolve, reject ) {

		var where = query.length > 0 ? {
			$or: [
				{
					organisation_id: config.default_organisation_id
				},
				{
					name: {
						$like: '%' + query + '%'
...
module.exports.save = function ( User ) {
	return new Promise(function ( resolve, reject ) {
		...
		if ( module.exports.user_type_ids.indexOf(parseInt(User.user_type_id)) === -1 ) {
		...
		var password_hash = module.exports.createPasswordHash(User.email, User.password);
...
module.exports.cleanAuthUser = function ( User ) {
	return {
		id             : User.id,
		email          : User.email,
...
module.exports.cleanUser = function ( User ) {
	var CleanUser = module.exports.cleanAuthUser(User);
